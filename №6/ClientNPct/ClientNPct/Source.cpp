...
int main()
{
	...
	if(!(CallNamedPipe(TEXT("\\\\Clabuyakchai\\pipe\\NONAME"), bufWrite, sizeof(bufWrite), bufRead, sizeof(bufRead), &dwCall, NMPWAIT_WAIT_FOREVER)))
		throw SetPipeError("CallNamedPipe:", WSAGetLastError());
